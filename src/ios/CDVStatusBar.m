...
{
    [self.commandDelegate sendPluginResult:[CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsInt:Int(ceil([[UIApplication sharedApplication] statusBarFrame].size.height))]]
}
